...
CurrentCoordsMessage::~CurrentCoordsMessage()
{
}
...
void CurrentCoordsMessage::copy(const CurrentCoordsMessage& other)
{
    this->x = other.x;
    this->y = other.y;
    this->z = other.z;
...
void CurrentCoordsMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
...
void CurrentCoordsMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
...
class CurrentCoordsMessageDescriptor : public omnetpp::cClassDescriptor
{
  private:
...
CurrentCoordsMessageDescriptor::~CurrentCoordsMessageDescriptor()
{
    delete[] propertynames;
}

bool CurrentCoordsMessageDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<CurrentCoordsMessage *>(obj)!=nullptr;
}

const char **CurrentCoordsMessageDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *CurrentCoordsMessageDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : nullptr;
}

int CurrentCoordsMessageDescriptor::getFieldCount() const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 3+basedesc->getFieldCount() : 3;
}

unsigned int CurrentCoordsMessageDescriptor::getFieldTypeFlags(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
...
const char *CurrentCoordsMessageDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *CurrentCoordsMessageDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int CurrentCoordsMessageDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *CurrentCoordsMessageDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string CurrentCoordsMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool CurrentCoordsMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *CurrentCoordsMessageDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *CurrentCoordsMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
